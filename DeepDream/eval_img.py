...
def evaluate(_):
    ...
    cv2.imwrite(r"D:\Face Masking YOLO\DeepDream\yolo_images\\" +img_path.split("\\")[-1],img)
    cv2.waitKey(0)
    ...
    #call(["tesseract", r"D:\Face Masking YOLO\DeepDream\yolo_images\test.jpg", r"D:\Face Masking YOLO\DeepDream\ocr"], stdout=FNULL)
